---
name: dumplink
description: Turn a shaped project into vertical task groups, dependency-aware sequence, risk state, and variable-scope implementation plan.
planning: true
...
Dumplink is for deliberate build-cycle work, not reactive ticket intake. It keeps the project whole while helping the team discover vertical task groups that can be finished, judged, and shipped within an appetite.
...
|---|---|---|---|---|---|---|
| TG-01 |  | T-01, T-04 |  | unknown / known / done | no |  |
